...
```{r sample_summary_heatmap, message = FALSE, warning=FALSE, fig.width = 6, fig.height = 18}
...
for ( i in 1:length(mafFiles) ) {
  ...
  layout(width  = 900, height = 620, margin = list(l=150, r=10, b=80, t=50, pad=2), titlefont = list(size=16), xaxis = list(tickfont=list(size=10)), yaxis = list(tickfont=list(size=10)))
...
```{r gene_summary_heatmap, message = FALSE, warning=FALSE, fig.width = 6, fig.height = 18}
suppressMessages(library(plotly))
suppressMessages(library(heatmaply))
