...
```{r load_data, message=F, warning=F, include = FALSE}
...
```{r maf_tcga_cohorts, message=F, warning=F, include = FALSE}
###### Generate separate plot for each cohort
for ( i in 1:length(mafFiles) ) {
...
```{r maf_visualisation_pdf, message=F, warning=F, include = FALSE}
