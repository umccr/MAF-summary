...
for ( i in 1:length(mafFiles) ) {
    ...
    addWorksheet(wb, paste0(cohorts.list[i], " (fraction)"), tabColour = cohorts.colour[[1]][i])
    writeData(wb, sheet = i, titv.info$fraction.contribution)
    
    addWorksheet(wb, paste0(cohorts.list[i], " (count)"), tabColour = cohorts.colour[[1]][i])
    writeData(wb, sheet = i, titv.info$raw.counts)
    
    addWorksheet(wb, paste0(cohorts.list[i], " (TiTv fractions)"), tabColour = cohorts.colour[[1]][i])
    writeData(wb, sheet = i, titv.info$TiTv.fractions)
}
