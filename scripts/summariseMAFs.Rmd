...
for ( i in 1:length(mafFiles) ) {
  ...
  ##### Save the plot as PNG
  png( file = paste(outDir, "/MAF_oncoplot_pathways_", datasets.list[i], ".png", sep = ""), width = 1800, height = oncoplot_height[[i]]+(100*length(params$pathways)), units = "px", res = 200, type="cairo" )
