...
## Summarise MAF files - tables {.tabset}
...
## Summarise MAF files - heatmaps {.tabset .tabset-fade}
...
```{r sample_summary_heatmap, message = FALSE, fig.width = 6, fig.height = 9}
...
```{r gene_summary_heatmap, message = FALSE, fig.width = 6, fig.height = 9}
suppressMessages(library(plotly))
suppressMessages(library(heatmaply))
