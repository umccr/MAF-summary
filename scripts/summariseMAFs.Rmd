...
for ( i in 1:length(mafFiles) ) {
  ...
  ##### Save the plot as PNG
  png( file = paste(outDir, "/MAF_oncoplot_goi_", datasets.list[i], "_COSMIC_signatures_comp.png", sep = ""), width = 1200, height = 1200, units = "px", res = 200, type="cairo" )
  ...
  cat("<br/>")
  cat("![](",paste(outDir, "/MAF_oncoplot_goi_", datasets.list[i], "_COSMIC_signatures_comp.png", sep = ""),")\n")
  cat("<br/><br/>")
  cat("\n</details>\n")
}
```
